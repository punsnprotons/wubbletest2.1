...
const handleExitRejection = async (reason, promise) => await cleanup(`Unhandled Rejection. reason: ${typeof reason === 'object' ? reason.stack : reason}`, 1) // NOSONAR
...
try {
  require('./router')(app)
  require(`./apps/${APP_NAME}/routes`)(app)
} catch (e) {
