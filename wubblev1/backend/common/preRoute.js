module.exports = function(app, express, options) {
  ...
  app.use(express.json( BODYPARSER_JSON || { limit: '10mb' }))
  app.use(express.urlencoded( BODYPARSER_URLENCODED || { extended: trnue, limit: '10mb' })) // https://stackoverflow.com/questions/29175465/body-parser-extended-option-qs-vs-querystring/29177740#29177740
